...
<footer className="bg-gray-900 mt-5 w-full">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
              <a href="/" className="flex items-center">
              <Image height={20} width={20} alt="Logo" src="/logo.png" />
                  <span className="self-center text-2xl font-semibold whitespace-nowrap text-white">Imaginify</span>
              </a>
          </div>
          <div className="grid grid-cols-3 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  <h2 className="mb-6 text-mm  font-bold  uppercase text-white">📄 Policies</h2>
                  <ul className="text-white font-medium">
                      ...
                      <li className="mb-2">
                          <a href="/refund_policy" className="hover:underline">Refund Policy</a>
                      </li>
                  </ul>
              </div>
              <div>
                  <h2 className="mb-6 text-mm  font-bold  uppercase text-white">Follow us 🔗</h2>
                  <ul className="text-white font-medium">
                      <li className="mb-2">
              ...
              <div>
                  <h2 className="mb-6 text-mm  font-bold  uppercase text-white">Create Artworks 🤖 </h2>
                  <ul className="text-white font-medium">
                      <li className="mb-2">
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-white sm:text-center dark:text-gray-400">© 2023 <a href="/" className="hover:underline">Imaginfy</a>. All Rights Reserved.
          </span>
